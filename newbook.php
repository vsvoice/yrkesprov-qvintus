...
<div class="container-fluid">
    ...
    ?>
    <h1 class="my-5 font-taviraj">Lägg till ny bok</h1>
		<form action="" method="post" enctype="multipart/form-data" class="">
            <div class="row">
                <div class="col-sm-6">
                    <label class="form-label" for="title">Titel</label><br>
                    <input class="form-control" type="text" name="title" id="title" required="required"><br>
                </div>

                <div class="col-sm-6">
                    <label class="form-label" for="price">Pris</label><br>
                    <input class="form-control" type="text" name="price" id="price" required="required"><br>
                </div>
            </div>

            <label class="form-label" for="cover-img">Omslagsbild</label><br>
            <input class="form-control" type="file" id="cover-img" name="cover-img" required="required"><br>
            <input type="hidden" name="cover-img-field-name" value="cover-img">

			<label class="form-label" for="description">Beskrivning</label><br>
			<textarea class="form-control" name="description" id="description" rows="4" required="required"></textarea><br>

            <div class="row">
            <div class="col-sm-6">
                <label class="form-label" for="publishing-date">Utgivningsdatum</label><br>
                <input class="form-control" type="date" name="publishing-date" id="publishing-date" required="required"><br>
            </div>
            <div class="col-sm-6">
                <label class="form-label" for="page-amount">Antal sidor</label><br>
                <input class="form-control" type="number" name="page-amount" id="page-amount" required="required"><br>
            </div>
            </div><br><br>
			...
			<input class="btn btn-primary py-2" type="submit" name="insert-book-submit" value="Lägg till bok">
		</form>
    </div>
</div>
