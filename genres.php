...
$newestPublishingYear = $book->getNewestProductPublishingYear();
$oldestPublishingYear = $book->getOldestProductPublishingYear();
$allBookPublishingYears = $book->getAllProductPublishingYears();

$earliestYear = $oldestPublishingYear['oldest_year'];

$allCategoriesArray = $book->getAllCategoriesWithAvailableProducts();
$allGenresArray = $book->getAllGenresWithAvailableProducts();
$allLanguagesArray = $book->getAllLanguagesWithAvailableProducts();
$allSeriesArray = $book->getAllSeriesWithAvailableProducts();
$allAgeRangesArray = $book->getAllAgeRanges();
$allPublishersArray = $book->getAllPublishersWithAvailableProducts();
...
<div class="container">
    ...
    <h1 class="my-5 font-taviraj">Alla produkter</h1>
                                ...
                                <div class="accordion-body p-3">
                                    ...
                                    <select class="form-select mb-3" id="newest" name="newest" aria-label="Size 3 select example"  onchange='this.form.submit();'>
                                        ...
                                        foreach ($allBookPublishingYears as $publishedYear) {
                                            ...
                                            if(!isset($_GET['newest']) && $year == $newestPublishingYear['newest_year'] || isset($_GET['newest']) && $_GET['newest'] == $year) {
                                    ...
                                    <select class="form-select mb-2" id="oldest" name="oldest" aria-label="Size 3 select example"  onchange='this.form.submit();'>
                                        ...
                                        foreach ($allBookPublishingYears as $publishedYear) {     
                                            ...
                                            echo "<option value='{$year}' "; 
                                            if(!isset($_GET['oldest']) && $year == $oldestPublishingYear['oldest_year'] || isset($_GET['oldest']) && $_GET['oldest'] == $year) {
                                                $selectAttribute = "selected";
                                            }
                                            echo "{$selectAttribute}>{$year}</option>";
                                        }   
